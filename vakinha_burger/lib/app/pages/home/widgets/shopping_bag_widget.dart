  ...
  Future<void> _goOrder(BuildContext context) async {
    ...
    if (!sp.containsKey('accessToken')) {
      ...
      if (loginResult == null || loginResult == false) {
        return;
        // só com o return assim, ele termina assim, premature return...
        // o código para por aqui e não faz mais nada...
      }
    }
    // Envio para o order
        ...
        child: Stack(
          children: [
            ...
            Align(
              ...
              child: Text(
                'Ver Sacola',
                style: context.textStyles.textExtraBold.copyWith(fontSize: 14.0),
              ),
            ),
            Align(
              ...
              child: Text(
                totalBag,
                style: context.textStyles.textExtraBold.copyWith(fontSize: 11.0),
              ),
            ),
          ],
        ),
